...
/** Render selectbox */
render(
    <SelectSearch name="font" value="Playfair Display" renderOption={renderFontOption} renderValue={renderFontValue} search={false} options={fontStacks} placeholder="Choose font" />,
    fontElement,
);
