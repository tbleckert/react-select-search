...
var fontElement = document.getElementById('fontSelect');
var friendsElement = document.getElementById('friendsSelect');
var fontStacks = [{ name: 'Roboto', value: 'Roboto', 'data-stack': 'Roboto, sans-serif' }, { name: 'Playfair Display', value: 'Playfair Display', 'data-stack': '"Playfair Display", serif' }, { name: 'Monoton', value: 'Monoton', 'data-stack': 'Monoton, cursive' }, { name: 'Gloria Hallelujah', value: 'Gloria Hallelujah', 'data-stack': '"Gloria Hallelujah", cursive' }, { name: 'VT323', value: 'VT323', 'data-stack': 'VT323, monospace' }];
// https://randomuser.me/
var friends = [{ name: 'Annie Cruz', value: 'annie.cruz', photo: 'https://randomuser.me/api/portraits/women/60.jpg' }, { name: 'Eli Shelton', value: 'eli.shelton', photo: 'https://randomuser.me/api/portraits/men/7.jpg' }, { name: 'Loretta Rogers', value: 'loretta.rogers', photo: 'https://randomuser.me/api/portraits/women/51.jpg' }, { name: 'Lloyd Fisher', value: 'lloyd.fisher', photo: 'https://randomuser.me/api/portraits/men/34.jpg' }, { name: 'Tiffany Gonzales', value: 'tiffany.gonzales', photo: 'https://randomuser.me/api/portraits/women/71.jpg' }];
/** https://gist.github.com/Keeguon/2310008 */
var countryOptions = require('./data/countries');

var fontStack = void 0;

/** Render selectbox */
(0, _reactDom.render)(_react2.default.createElement(_reactSelectSearch2.default, { name: 'font', value: 'Playfair Display', renderOption: renderFontOption, onChange: onSelectChange, onBlur: onBlur, onMount: onBlur, options: fontStacks, search: false, placeholder: 'Choose font' }), fontElement);

function getSearchElement(props) {
    var outElement = document.querySelector('[name="' + props.name + '"]');
...
function setFontStackOnSearch(value, props) {
    var search = getSearchElement(props);
...
(0, _reactDom.render)(_react2.default.createElement(_reactSelectSearch2.default, {
    name: 'country',
    mode: 'input',
    value: 'SE',
    options: countryOptions,
    placeholder: 'Your country' }), countryElement);
...
function renderFriend(option) {
    ...
    return _react2.default.createElement(
        'span',
        null,
        _react2.default.createElement('img', { style: imgStyle, width: '40', height: '40', src: option.photo }),
...
(0, _reactDom.render)(_react2.default.createElement(_reactSelectSearch2.default, { name: 'friends', multiple: true, height: 172, options: friends, placeholder: 'Search friends', renderOption: renderFriend }), friendsElement);

},{"./data/countries":2,"./react-select-search":33,"react":31,"react-dom":27}],2:[function(require,module,exports){
...
},{"./lib/ReactPropTypesSecret":24,"_process":19,"fbjs/lib/invariant":12,"fbjs/lib/warning":16}],21:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":24,"fbjs/lib/emptyFunction":7,"fbjs/lib/invariant":12}],22:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":20,"./lib/ReactPropTypesSecret":24,"_process":19,"fbjs/lib/emptyFunction":7,"fbjs/lib/invariant":12,"fbjs/lib/warning":16,"object-assign":18}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"fbjs/lib/ExecutionEnvironment":3,"fbjs/lib/containsNode":6,"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/getActiveElement":9,"fbjs/lib/invariant":12,"fbjs/lib/shallowEqual":15,"object-assign":18,"react":31}],27:[function(require,module,exports){
(function (process){
'use strict';
...
},{"react":31,"react-dom":27}],29:[function(require,module,exports){
(function (process){
/** @license React v16.3.2
...
},{"_process":19,"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/invariant":12,"fbjs/lib/warning":16,"object-assign":18,"prop-types/checkPropTypes":20}],30:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/invariant":12,"object-assign":18}],31:[function(require,module,exports){
(function (process){
'use strict';
...
function _inherits(subClass, superClass) {
  ...
  }_setPrototypeOf(subClass.prototype, superClass && superClass.prototype);if (superClass) _setPrototypeOf(subClass, superClass);
}
...
},{"./Bem":32,"fuse.js":17,"prop-types":23,"react":31,"react-onclickoutside":28}]},{},[1])
